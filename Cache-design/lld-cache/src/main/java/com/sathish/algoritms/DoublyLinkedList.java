package com.sathish.algoritms;

import lombok.Getter;

import java.util.NoSuchElementException;

import com.sathish.algoritms.exceptions.InvalidElementException;
...
public class DoublyLinkedList<E> {
    ...
    public DoublyLinkedList() {
        // We can instantiate these by null, since we are never going to aasign any value for these dummyNodes
